...
//        val flowStepNumber = arguments?.getInt("flowStepNumber")  0011
        ...
        return when (flowStepNumber) {
            2 -> inflater.inflate(R.layout.navigation_flow_step_two_fragment, container, false)
            else -> inflater.inflate(R.layout.navigation_flow_step_one_fragment, container, false)
        }
