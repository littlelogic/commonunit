...
import com.teaphy.diffutildemo.adapter.AsyncListDifferAdapter
import com.teaphy.diffutildemo.bean.DiffBean
import kotlinx.android.synthetic.main.differ_activity_async_list_differ.*
...
class AsyncListDifferActivity : AppCompatActivity() {
    ...
    private val mAdapter: AsyncListDifferAdapter = AsyncListDifferAdapter()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.differ_activity_async_list_differ)
    ...
    private fun initView() {
        ...
        rvDiff.apply {
            layoutManager = LinearLayoutManager(this@AsyncListDifferActivity, LinearLayoutManager.VERTICAL, false)
            adapter = mAdapter
        }
